...
import com.example.moviesapp.ui.TopRatedTvSeriesDetails;
import com.example.moviesapp.ui.TvSeriesDetails;
import com.flaviofaria.kenburnsview.KenBurnsView;

import java.util.List;

public class TopRatedTVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int ITEM = 0;
    private static final int LOADING = 1;
    private List<TopRatedTVSeries.ResultsBean> movies;
    private Context context;
    private boolean isLoading;

    public TopRatedTVAdapter(List<TopRatedTVSeries.ResultsBean> movies, Context context) {
        this.movies = movies;
        this.context = context;

    }

    public List<TopRatedTVSeries.ResultsBean> getMovies() {
        return movies;
    }

    public void setMovies(List<TopRatedTVSeries.ResultsBean> movies) {
        this.movies = movies;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if(holder instanceof MovieVH){
            TopRatedTVSeries.ResultsBean model = movies.get(position);
    ...
    public void add(TopRatedTVSeries.ResultsBean mc) {
        movies.add(mc);
        notifyItemInserted(movies.size() - 1);
    }

    public void addAll(List<TopRatedTVSeries.ResultsBean> mcList) {
        for (TopRatedTVSeries.ResultsBean mc : mcList) {
            add(mc);
        }
    }
    ...
    public void addLoadingFooter() {
        isLoading = true;
        add(new TopRatedTVSeries.ResultsBean());
    }
    ...
    public void removeLoadingFooter() {
        ...
        TopRatedTVSeries.ResultsBean item = getItem(position);
    ...
    public TopRatedTVSeries.ResultsBean getItem(int position) {
