...
public class TopRatedTvTrailerAdapter extends RecyclerView.Adapter<TopRatedTvTrailerAdapter.TrailerViewHolder> {

    private List<TopRatedTvTrailerModel.ResultsBean> trailerList;
    private Context context;

    public TopRatedTvTrailerAdapter(List<TopRatedTvTrailerModel.ResultsBean> trailerList, Context context) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(position != RecyclerView.NO_POSITION){
                        TopRatedTvTrailerModel.ResultsBean model = trailerList.get(position);
