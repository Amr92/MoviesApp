...
public class MoreCelebsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MoreCelebsAdapter(Context context) {
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        View v1 = inflater.inflate(R.layout.item_rec_more_celebs, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if(holder instanceof MovieVH){
            ...
            movieVH.celebsPopularity.setText(String.valueOf(model.getPopularity()));
