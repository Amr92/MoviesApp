...
public class PopularMoviesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<PopularMoviesModel.ResultsBean> movies;
    private Context context;
    private boolean isLoading;

    public PopularMoviesAdapter(List<PopularMoviesModel.ResultsBean> movies, Context context) {
        this.movies = movies;
        this.context = context;

    }

    public List<PopularMoviesModel.ResultsBean> getMovies() {
        return movies;
    }

    public void setMovies(List<PopularMoviesModel.ResultsBean> movies) {
        this.movies = movies;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if(holder instanceof MovieVH){
            PopularMoviesModel.ResultsBean model = movies.get(position);
    ...
    public void add(PopularMoviesModel.ResultsBean mc) {
        movies.add(mc);
        notifyItemInserted(movies.size() - 1);
    }

    public void addAll(List<PopularMoviesModel.ResultsBean> mcList) {
        for (PopularMoviesModel.ResultsBean mc : mcList) {
            add(mc);
        }
    }
    ...
    public void addLoadingFooter() {
        isLoading = true;
        add(new PopularMoviesModel.ResultsBean());
    }
    ...
    public void removeLoadingFooter() {
        ...
        PopularMoviesModel.ResultsBean item = getItem(position);
    ...
    public PopularMoviesModel.ResultsBean getItem(int position) {
