...
public class PopularMovieDetailsModel {
    ...
    public List<ProductionCountriesBean> production_countries;
    public List<SpokenLanguagesBean> spoken_languages;
    ...
    public static class ProductionCompaniesBean {
        ...
        public ProductionCompaniesBean(int id, Object logo_path, String name, String origin_country) {
            this.id = id;
    ...
    public static class ProductionCountriesBean {
        ...
        public ProductionCountriesBean(String iso_3166_1, String name) {
    ...
    public static class SpokenLanguagesBean {
        ...
        public SpokenLanguagesBean(String iso_639_1, String name) {
    ...
    public class BelongsToCollection {
        ...
        public BelongsToCollection(Integer id, String name, String poster_path, String backdrop_path) {
            this.id = id;
            this.name = name;
            this.poster_path = poster_path;
            this.backdrop_path = backdrop_path;
