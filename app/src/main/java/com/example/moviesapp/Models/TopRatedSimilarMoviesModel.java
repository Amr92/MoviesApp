...
public class TopRatedSimilarMoviesModel {
    ...
    public TopRatedSimilarMoviesModel() {
    }

    public TopRatedSimilarMoviesModel(int page, int total_pages, int total_results, List<ResultsBean> results) {
        this.page = page;
